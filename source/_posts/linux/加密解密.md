...
- 查看并更新托管的证书: 再次执行wacs.exe文件 - A: Manage renewals (1 total) 可查看托管的自动更新证书 - R: Renew all certificates
- 自动更新托管的证书?: `wacs.exe --renew --baseuri "https://acme-v02.api.letsencrypt.org/"`
- 路径验证nginx配置
