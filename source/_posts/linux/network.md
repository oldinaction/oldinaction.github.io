...
- [下载5.0后破解(科学上网)](https://www.zzzmode.com/mytools/charles/)，如`moon/ef30d3ee8ee17ac30d`
- 参考: https://www.zhoulujun.cn/html/tools/NetTools/PacketCapture/8908.html

### Wireshark抓包

- 参考
    - https://www.cnblogs.com/shadow-fy/p/17754479.html
- 如果是公网抓包，一般需要选择监听类似以太网的网卡
- 常用表达式

```bash
# 监听本机发送给114.114.114.114的包
ip.src == 192.168.1.100 && ip.dst == 114.114.114.114
# 监听本机发送和收到的114.114.114.114的包
(ip.src == 192.168.1.100 && ip.dst == 114.114.114.114) || (ip.src == 114.114.114.114 && ip.dst == 192.168.1.100)
# 监听本机发送给服务器80端口的包
